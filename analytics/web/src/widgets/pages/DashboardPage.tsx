...
export function DashboardPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Получаем все туалеты с их отзывами (ratings уже внутри)
        const toiletsData = await api.toiletsControllerGetAllToilets();
        setToilets(toiletsData);

        // Собираем все отзывы из всех туалетов
        ...
        // Расчет средних оценок по всем отзывам
        ...
        // Расчет рейтинга для каждого туалета
        ...
        // Худшие туалеты (только с отзывами)
        ...
        // Самый активный туалет (больше всего отзывов)
